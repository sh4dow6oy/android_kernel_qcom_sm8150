...
// === FIX AUTOMAT PENTRU KERNEL MINIMALIST ===
void __weak wake_ion_rbin_heap_shrink(void) {
    /* Cu __weak, dacă linkerul o găsește în rbincache.o, o va ignora pe asta și nu mai crapă! */
}
